...
CFS dodaje usługi szyfrujące do systemu plików Unixów. Obsługuje on
bezpieczny zapis informacji poprzez standardowy interfejs systemu
plików dostępny w Uniksach. Użytkownicy przypisują kryptograficzne
klucze tym katalogom, które chcą zabezpieczyć. Pliki w tych katalogach
(jak również ich nazwy) są przezroczyście szyfrowane i deszyfrowane z
podanym kluczem; dane czystym tekstem nigdy nie są zapisywane na dysku
